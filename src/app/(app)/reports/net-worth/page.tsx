...
import { getNetWorthReport, reportYearOptions } from "../reportQueries";
import NetWorthReportView from "./NetWorthReportView";

export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations();
  return { title: t("reports.netWorth.metaTitle") };
}
...
export default async function NetWorthReportPage({
  ...
  const data = await getNetWorthReport(workspace.budget.id, year);
